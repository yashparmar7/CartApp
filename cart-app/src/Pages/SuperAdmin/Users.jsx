                ...
                <tbody className="divide-y divide-gray-50 font-medium text-sm">
                  {users.length === 0 ? (
                    <tr>
                      <td
                        colSpan="4"
                        className="py-20 text-center bg-gray-50/30"
                      >
                ...
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-gray-400 font-bold mt-0.5 italic">
                        {user.email}
                      </p>
                    </div>
                  </div>
              ...
              <div className="relative z-10 flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-black uppercase tracking-tight leading-none">
                    Role <span className="text-red-500">Control</span>
                  </h2>
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="p-5 bg-gray-50 rounded-3xl border border-gray-100 space-y-4 shadow-inner">
                ...
                <div className="pt-3 border-t border-gray-200/60">
                  ...
                  <p className="text-xs font-bold text-gray-600 truncate mt-1 italic">
                    {selectedUser.email}
                  </p>
                </div>
              </div>

              {/* Actionable Role Selection */}
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="absolute right-5 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400 group-focus-within:text-red-500">
                ...
                <div className="bg-amber-50 p-4 rounded-2xl border border-amber-100 flex items-start gap-3">
                  ...
                  <p className="text-[10px] font-bold text-amber-700 leading-relaxed uppercase tracking-tight">
                    Caution: Modifying account role changes the user's data
                    access. Verify identity before granting Admin or Seller
                    status.
                  </p>
                </div>
              </div>

              {/* ACTIONS: Tactical Pilling */}
